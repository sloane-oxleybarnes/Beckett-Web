      ...
      <div className="relative bg-white rounded-t-2xl sm:rounded-2xl w-full max-w-md max-h-[85vh] overflow-y-auto p-6 shadow-xl">
        ...
        {trustedPeople.length === 0 && (
          <p className="text-xs leading-relaxed text-ink-light">
            No contacts are available yet. Analyze a selected conversation in the Gmail™ add-on or{' '}
            <a href="/dashboard/contacts" className="text-primary underline">add someone in Contacts</a>.
          </p>
        )}
      </div>
    </div>
