      ...
      {loading ? (
        ...
        <div className="rounded-card border border-border bg-white p-8 text-center">
          ...
          <p className="mx-auto mb-6 max-w-md text-sm leading-relaxed text-ink-mid">
            Connect or manage Google Calendar in Settings. Beckett uses only the calendars you choose there.
          </p>
          <p className="mx-auto mb-5 max-w-md text-xs leading-relaxed text-ink-light">
            You can choose calendars, reconnect, or disconnect at any time in Connected accounts.
          </p>
          <button
            type="button"
            onClick={() => window.location.assign("/dashboard/settings#connected-accounts")}
