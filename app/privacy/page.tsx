...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "The Microsoft 365 connection uses delegated read-only access. It reads only basic event details from calendars you select, and reads mail only when you choose full-thread analysis for a selected Outlook conversation. Outlook message content is user-selected and is sent to Beckett only for the requested coaching action.",
  ...
  return (
    <main className="min-h-screen bg-bg text-ink">
      ...
      <section className="mx-auto w-full max-w-4xl px-5 py-12">
        ...
        <p className="mt-4 text-sm text-ink-light">Last updated: August 31, 2026</p>
      </section>
