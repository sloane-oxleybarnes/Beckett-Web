...
- Staging Beckett contacts, identifiers, and relationship summaries.

Use this only with demo accounts and the staging Supabase project.

## Recommended Setup

1. Create a dedicated demo Google account, for example `beckett.demo@gmail.com`.
2. Connect that Google account to the staging Beckett app.
...
6. Apply the Phase 4 staging migration before seeding contacts.
...
Required for staging contact seeding:
...
- Do not use production Supabase keys.
