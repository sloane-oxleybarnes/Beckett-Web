...
export const CONNECTED_APPS: ConnectedAppDefinition[] = [
  ...
  },
  {
    ...
    connectHref: "/slack/install?mode=connect",
    connectLabel: "Add to Slack",
    steps: [
      "Review Beckett's public-beta notice, then choose Add to Slack.",
      "Review the six bot permissions and select the workspace you use for work.",
