...
export type MCRound = { scenario: string; question?: string; scenarioMessage?: ScenarioMessage; options: MCOption[] }
...
export type MultiSelectRound = { scenario: string; question: string; scenarioMessage?: ScenarioMessage; options: MultiSelectOption[]; explanation: string }
...
export type OpenPracticeConfig = {
  ...
  goal: string
  helperChecklist?: string[]
  progressChecklist?: { key: string; label: string; patterns: string[] }[]
...
const askSomeoneOut: Course = {
  ...
  reviewSummary: {
    title: 'Clear Ask formula review',
    description: 'Use this when you want to move from a promising connection to one respectful, low-pressure next step.',
    formulas: [
      { label: 'Warm signal', text: 'Name one genuine thing you have enjoyed about the connection.' },
      { label: 'Specific plan', text: 'Offer one concrete, public, and manageable first step.' },
      { label: 'Easy out', text: 'Make room for an honest no without hiding that you are interested.' },
    ],
    checklist: [
      'There is enough mutual effort to make asking reasonable',
      'The invitation names one specific plan',
      'The first meeting is public and easy to leave',
      'The other person can answer without managing my feelings',
      'I am prepared to respect a yes, no, maybe, or no reply',
    ],
  },
  openPractice: {
    matchName: 'Jamie',
    ...
    introTitle: 'Open Practice: Make a clear, low-pressure ask',
    introDescription: 'Now you’ll practice the full Clear Ask Formula in a realistic dating-app conversation. Jamie seems interested and has been contributing to the chat, but they are still getting to know you. Your goal is to express interest clearly while leaving Jamie free to answer honestly.',
    ...
    progressChecklist: [
      { key: 'warmth', label: 'Connection named', patterns: ['liked', 'enjoyed', 'fun', 'laughing', 'conversation', 'talking', 'debate', 'humor', 'easy'] },
      { key: 'plan', label: 'Specific plan offered', patterns: ['coffee', 'cafe', 'walk', 'lunch', 'bookstore', 'video call', 'meet', 'Saturday', 'Sunday', 'weekend', 'this week'] },
      { key: 'choice', label: 'Room to choose', patterns: ['no pressure', 'no worries', 'totally okay', 'feel free', 'if you are', 'if that feels', 'rather keep chatting'] },
    ],
    contextPanel: {
      title: 'What you already know',
      items: [
        'You and Jamie matched on a dating app.',
        'You have both contributed to the conversation.',
        'You have joked about music, weekend plans, and coffee shops.',
        'Jamie seems interested, but you are still early in getting to know each other.',
        'A public, time-limited first step is the safest fit for this context.',
      ],
    },
    starterMessages: [
...
Never break character. You are Jamie, not Beckett.`,
  ...
  slides: [
    ...
    {
      type: 'accordion',
      title: 'After You Ask: Respect the Answer',
      description: 'A clear invitation is only half of the skill. The next step is responding to the answer without pushing, bargaining, or turning uncertainty into a verdict about your worth.',
      sections: [
        { heading: 'If they say yes', bullets: ['Confirm the practical details without escalating the emotional intensity.', 'Example: “Great — would Saturday at 2 work for the cafe near the park?”'] },
        { heading: 'If they say no', bullets: ['Accept the answer once and keep your response short.', 'Example: “Thanks for being direct. No worries.”'] },
        { heading: 'If they say maybe or stay vague', bullets: ['Offer one chance to clarify, then let them take the next step.', 'Example: “No problem. If you want to revisit it, let me know.”'] },
        { heading: 'If they do not reply', bullets: ['Do not send repeated asks or demand an explanation.', 'No reply can have many causes, but it still means you do not have a yes. Give the conversation space.'] },
      ],
    },
    {
      type: 'multiple-choice',
...
const introducingNewColleague: Course = {
  ...
  reviewConversationTurns: 4,
  reviewSummary: {
    title: 'Useful Introduction formula review',
    description: 'Use this when meeting a new colleague so they quickly understand who you are, how your work connects, and what makes collaboration easier.',
    formulas: [
      { label: 'Who you are', text: 'Give your name, team, role, or project connection.' },
      { label: 'What you do', text: 'Describe the part of your work that is most relevant to this person.' },
      { label: 'How you collaborate', text: 'Name one useful preference or practical next step.' },
    ],
    checklist: [
      'The other person can place me in the work',
      'I gave relevant context instead of my full background',
      'My warmth matches the setting',
      'I named a preference without apologizing for it',
      'I made the next point of collaboration easier',
    ],
  },
  openPractice: {
    matchName: 'Maya',
    ...
    introTitle: 'Open Practice: Start a useful working relationship',
    introDescription: 'Now you’ll practice introducing yourself to Maya in a realistic Slack DM. Maya is friendly but busy and has just joined a project you both support. Your goal is to be warm, give the context she needs, and make it easier for the two of you to work together.',
    goal: 'Introduce yourself, give Maya useful context, and make the next collaboration step clear.',
    helperChecklist: [
      'Say who you are and how you connect to the project',
      'Name the part of the work most relevant to Maya',
      'Share one useful strength, preference, or resource',
      'Offer a clear next step or invite a practical question',
      'Keep personal disclosure intentional and work-relevant',
    ],
    progressChecklist: [
      { key: 'identity', label: 'Role or team shared', patterns: ['I am', 'I’m', 'team', 'role', 'work on', 'support', 'own'] },
      { key: 'connection', label: 'Project connection explained', patterns: ['onboarding', 'beta', 'project', 'flow', 'work together', 'working together'] },
      { key: 'collaboration', label: 'Collaboration made easier', patterns: ['I can', 'happy to', 'help with', 'send', 'share', 'recap', 'questions', 'connect', 'next steps'] },
    ],
    contextPanel: {
      title: 'What you already know',
      items: [
        'Maya is a new cross-functional colleague.',
        'Jordan told her you will both support the beta onboarding work.',
        'Maya is about to read the project document.',
        'She does not yet know what you own or how your work connects to hers.',
        'This is a Slack DM, so a concise, conversational introduction fits best.',
      ],
    },
    starterMessages: [
...
Never break character. You are Maya, not Beckett.`,
  ...
  slides: [
    {
      type: 'interactive-read',
      title: 'What a Work Introduction Needs to Do',
      description: 'A useful introduction is not a performance or a compressed résumé. It gives a new colleague enough context to understand where you fit, what they can come to you for, and how to take the next step with you.',
      sections: [
        { heading: 'The goal', bullets: ['Help the other person place you in the work.', 'Give them one useful point of connection.', 'Make the next interaction easier than the first.'] },
        { heading: 'What you do not owe', bullets: ['Your full work history.', 'An apology for your communication preferences.', 'Personal or diagnostic information you do not want to share.'] },
        { heading: 'What changes by setting', bullets: ['Slack can be short and conversational.', 'Email usually needs a clear reason for reaching out.', 'A live introduction can be one or two sentences, followed by a question.'] },
      ],
    },
    {
      type: 'reflection-choice',
    ...
    },
    {
      ...
      items: [
        ...
        { message: '"Hi, I am Alex from product. Let me know if you need anything."', correct: 'Too vague', explanation: 'It is polite, but it does not explain what Alex owns or what kind of help they can offer.' },
        { message: '"I get overwhelmed in meetings, forget verbal instructions, and have had problems with coworkers misunderstanding me."', correct: 'Too much personal context', explanation: 'Those experiences may be real, but a first introduction does not require this level of disclosure.' },
        { message: '"I own the first-run onboarding flow, so I can help with the background behind the current decisions."', correct: 'Balanced', explanation: 'It gives specific, relevant context and makes collaboration easier.' },
        { message: '"Sorry in advance — I ask a lot of questions and can be kind of intense about details."', correct: 'Too much personal context', explanation: 'This frames a potentially useful preference as a warning and asks the colleague to judge it before working together.' },
        { message: '"Written next steps help me stay aligned, and I am happy to send a recap after we connect."', correct: 'Balanced', explanation: 'It names a useful preference and shows how it benefits both people.' },
        { message: '"I am around if needed."', correct: 'Too vague', explanation: 'The colleague still has to guess what the person can help with.' },
      ],
    },
    {
      type: 'flip-cards',
      title: 'Adapt the Same Introduction to the Setting',
      description: 'The core information can stay the same while the length and next step change. You do not need a different personality for every channel.',
      cards: [
        { front: 'Slack', back: ['Keep it conversational and easy to scan.', 'Name the project connection and offer one practical resource or next step.'] },
        { front: 'Email', back: ['Use a clear reason for reaching out.', 'Include enough context that the message makes sense when read later.'] },
        { front: 'Live meeting', back: ['Use one or two sentences, then leave room for the other person.', 'A simple question can turn the introduction into a conversation.'] },
        { front: 'Personal disclosure', back: ['Share only what you want and what is useful for this working relationship.', 'You can name a collaboration preference without explaining a diagnosis or personal history.'] },
      ],
    },
    {
      type: 'visual-formula',
    ...
    {
      type: 'multiple-choice',
      title: 'Choose the Most Useful Introduction',
      description: 'Put the full formula together. Choose the introduction that gives the other person enough context, matches the setting, and makes collaboration easier without overexplaining.',
      helperChecklist: [
        'Who you are',
        'What you do that is relevant here',
        'One useful preference, resource, or next step',
      ],
      compactHelper: true,
      suppressDoneScreen: true,
      rounds: [
        {
          scenario: 'A new cross-functional colleague messages you in Slack before reading the project document.',
          options: [
            { text: 'A: “Hi! I am Alex from product. I own the first-run onboarding flow, so I can help with context behind the current decisions. Happy to point you to the most useful sections of the doc.”', correct: true, explanation: 'A is warm, relevant, and offers a concrete next step.' },
            { text: 'B: “Hi. Welcome.”', correct: false, explanation: 'B is friendly but gives the colleague no useful context.' },
            { text: 'C: “I have been here for four years and have worked across six different projects, so I can tell you everything that has ever happened with onboarding.”', correct: false, explanation: 'C overloads the first interaction with background the colleague does not need yet.' },
          ],
        },
        {
          scenario: 'You are introduced during a live project kickoff and have about 20 seconds.',
          options: [
            { text: 'A: “I am Alex from product. I focus on onboarding clarity and will be your partner for the first-run flow. I would love to hear which part you are jumping into first.”', correct: true, explanation: 'A is brief, relevant, and opens the door to collaboration.' },
            { text: 'B: “I should warn you that I process things differently and sometimes need people to repeat themselves.”', correct: false, explanation: 'B leads with a warning and more personal context than this moment requires.' },
            { text: 'C: “I work here too.”', correct: false, explanation: 'C does not help the colleague understand the connection.' },
          ],
        },
        {
          scenario: 'You want to name a collaboration preference in a first email.',
          options: [
            { text: 'A: “Written next steps help me stay aligned, and I am happy to send a recap after we meet.”', correct: true, explanation: 'A names the preference confidently and shows how it supports the work.' },
            { text: 'B: “Sorry, I am difficult about meetings and need everything written down.”', correct: false, explanation: 'B apologizes and frames the preference as a personal problem.' },
            { text: 'C: “You will figure out how I work eventually.”', correct: false, explanation: 'C leaves the other person to guess instead of making collaboration easier.' },
          ],
        },
      ],
    },
...
const askingForClarity: Course = {
  ...
  openPractice: {
    matchName: 'Priya',
    matchDescription: 'a busy, direct manager who tends to assume shared context',
    practiceKind: 'workplace',
    channel: 'slack',
    subtitle: 'Slack DM',
    introTitle: 'Open Practice: Ask for the missing details',
    introDescription: 'Now you’ll practice using the full Clarity Formula in a realistic Slack DM with your manager. Priya is busy, direct, and generally reasonable, but she tends to assume shared context. Your goal is not to write the whole readout yet — it is to collect enough information to know what kind of readout she needs.',
    goal: 'Ask Priya for the missing information you need before you start drafting the readout.',
    helperChecklist: [
      'Name what you already understand',
      'Name the specific unclear part',
      'Ask one specific answerable question',
      'Give options if that makes answering easier',
      'Do not apologize for needing the information',
    ],
    progressChecklist: [
      { key: 'format', label: 'Format confirmed', patterns: ['format', 'bullet', 'bullets', 'slide', 'slides', 'doc', 'document', 'readout', 'summary'] },
      { key: 'audience', label: 'Audience confirmed', patterns: ['audience', 'who is this for', 'who will read', 'product team', 'product sync'] },
      { key: 'detail', label: 'Level of detail confirmed', patterns: ['level of detail', 'how detailed', 'detailed', 'detail', 'quotes', 'examples', 'themes'] },
      { key: 'decision', label: 'Decision/use confirmed', patterns: ['decision', 'decide', 'prioritize', 'priority', 'priorities', 'discussion', 'support'] },
      { key: 'timing', label: 'Timing confirmed', patterns: ['tomorrow', 'deadline', 'when', 'by when', 'before the sync'] },
    ],
    contextPanel: {
      title: 'What you already know',
      items: [
        'Priya is your manager.',
        'She wants a quick readout from last week’s customer interviews.',
        'The readout is for tomorrow’s product sync.',
        'The product team is deciding what to prioritize next.',
        'Priya said to make it “useful,” but did not define the format, audience, level of detail, or what decision the readout should support.',
      ],
    },
    starterMessages: [
      { role: 'assistant', content: 'Can you pull together a quick readout from last week’s customer interviews before tomorrow’s product sync?', timestamp: '10:12 AM' },
      { role: 'assistant', content: 'Nothing too fancy — just make sure it’s useful for the discussion.', timestamp: '10:12 AM' },
    ],
    systemPrompt: `You are Priya, a busy, direct, but generally reasonable workplace manager in Slack. You gave the user a vague task: "Can you pull together a quick readout from last week’s customer interviews before tomorrow’s product sync? Nothing too fancy — just make sure it’s useful for the discussion."

The missing details are: the product managers are the audience, bullet points are enough, Priya wants the top 3 themes with 1-2 customer quotes, and the readout should help the team decide which onboarding fixes to prioritize next.

If the user asks clear clarifying questions, answer them and give useful next steps. If the user is vague, ask what part they need clarified. If they over-apologize, respond kindly but keep the conversation focused on the task.

Never break character. You are Priya, not Beckett.`,
  },
  slides: [
    {
      type: 'accordion',
      ...
      sections: [
        { heading: 'Why ask for clarification?', bullets: ['Asking for clarification gives you a clear understanding of what\'s being asked of you and how to execute on it. This ensures that you\'re solving the right problem at the right level before you spend your energy on it.'] },
        { heading: 'What can be unclear?', bullets: ['When something is asked of us there are many factors that dictate what is actually needed: Timeline (deadline & priority), definition of done, the audience and who the decision maker is are a few.'] },
      ],
    },
    {
      type: 'reflection-choice',
      title: 'Why Asking Can Feel Hard',
      description: 'Asking for clarification can be harder than it should be. Not because you don\'t understand or can\'t do the work — but because of everything that surrounds it.\nThe worry that you should already know. Not being sure what information you are even missing.\nThe sense that you are asking too much, taking too long, being annoying.\nThe impulse to apologize before you have said anything at all.\n\nThese are not character flaws. They are thought patterns — and these can be changed.',
      prompt: 'What concerns come up for you?',
      multi: true,
      options: [
    ...
    {
      type: 'side-by-side',
      title: 'Let’s Talk About Over-Apologizing',
      description: 'Many neurodivergent people grow up feeling like their questions are a burden — being told to stop asking, to just figure it out, or that they should already know. If that sounds familiar, it makes sense that asking for help now feels like something you need to apologize for. It is not.\n\nAsking clarifying questions is not a weakness. It is one of the clearest, most direct ways to communicate - and you don\'t need to apologize for it. This section will help you notice when you are over-apologizing and give you tools to ask for what you need without shrinking yourself to do it.',
      scenario: '',
      scenarioMessage: {
        sender: 'Your Manager',
        roleLabel: 'Text message',
        content: 'Can you clean up this document before the meeting later today?',
        channel: 'text',
      },
    ...
    },
    {
      ...
      description: 'Time to practice, match each over-apologetic question to a more direct version.',
      ...
      neutralChecked: true,
      pairs: [
        { left: { name: 'Clean up', description: 'I’m a little confused about what you mean by clean this up.', mismatchNote: 'Look for the version that asks what clean up means.' }, right: { name: 'Improved', description: 'Quick clarification: do you mean copy edits, structure, or both?' } },
        { left: { name: 'Deadline', description: 'I might have missed this, but when is this due?', mismatchNote: 'Look for the version that confirms deadline before prioritizing.' }, right: { name: 'Improved', description: 'I want to confirm the deadline before I prioritize this. When do you need this by?' } },
        { left: { name: 'Polish', description: 'I am probably overthinking this, but should I make this polished?', mismatchNote: 'Look for the version that asks rough versus polished.' }, right: { name: 'Improved', description: 'Does this need to be fully polished or are you expecting a rough internal draft?' } },
        ...
        { left: { name: 'Context', description: 'I feel like I missed something. What is this for?', mismatchNote: 'Look for the version that asks for background context.' }, right: { name: 'Improved', description: 'Is there background context or an example I should review before I start?' } },
      ],
    },
    {
      type: 'visual-formula',
      title: 'The Clarity Formula',
      description: 'Knowing you need clarification and knowing how and what to ask for it are two different things. This formula bridges that gap — giving your brain a clear structure to work from so asking feels less overwhelming.',
      steps: [
      ...
      rounds: [
        {
          ...
          scenarioMessage: {
            ...
            content: 'Hey - can you take a look at the onboarding doc and clean it up before the team review on Thursday?',
            channel: 'text',
          },
        ...
        },
        {
          ...
          scenarioMessage: {
            sender: 'Morgan',
            roleLabel: 'Teammate',
            content: 'Can you take over the client email for the Halford account? I have a conflict this afternoon.',
            channel: 'slack',
          },
          question: 'What do you already know from this message? Select all that apply.',
          options: [
        ...
        },
        {
          ...
          scenarioMessage: {
            sender: 'Alex',
            roleLabel: 'Senior colleague',
            content: 'I would love your input on the new process doc before it goes to leadership. Let me know what you think when you get a chance.',
            channel: 'email',
          },
          question: 'What do you already know from this message? Select all that apply.',
          options: [
    ...
    },
    {
      ...
      rounds: [
        {
          scenario: 'Your manager says, "Can you clean up the onboarding doc?"',
          scenarioMessage: {
            sender: 'Your Manager',
            roleLabel: 'Slack message',
            content: 'Can you clean up the onboarding doc?',
            channel: 'slack',
          },
          question: 'What important information is missing?',
          options: [
        ...
        {
          scenario: 'A teammate says, "Can you help with the launch issue?"',
          scenarioMessage: {
            sender: 'Morgan',
            roleLabel: 'Teammate',
            content: 'Can you help with the launch issue?',
            channel: 'slack',
          },
          question: 'What information is most missing?',
          options: [
        ...
        {
          scenario: 'Your skip-level manager says, "Can you take a look at the new process doc and let me know what you think?"',
          scenarioMessage: {
            sender: 'Riley',
            roleLabel: 'Skip-level manager',
            content: 'Can you take a look at the new process doc and let me know what you think?',
            channel: 'email',
          },
          question: 'What is the most important missing information?',
          options: [
    ...
    {
      type: 'sorting',
      title: 'Step 3 - How to Ask',
      description: 'The third step in the Clarity Formula is making sure the questions you ask are specific and not vague. A question like "can you clarify?" puts the work back on them. A question like "Do you need this by end of day or can it wait until end of week?" gives them something to respond to immediately — and gets you what you need faster.',
      instruction: 'Sort each message by what kind of clarity question it is.',
      categories: ['Strong Question', 'Needs Work'],
      items: [
        { message: 'Can you clarify?', correct: 'Needs Work', explanation: 'It does not say what part needs clarification.' },
        { message: 'When you say urgent, do you mean today or before Friday?', correct: 'Strong Question', explanation: 'Names the unclear word and gives two answerable options.' },
        { message: 'Sorry, I know this is probably obvious, but I am confused about what you want.', correct: 'Needs Work', explanation: 'The apology takes up more space than the question.' },
        { message: 'Should I focus first on the headline copy or the form steps?', correct: 'Strong Question', explanation: 'Specific and easy to answer.' },
      ],
    },
    {
      type: 'sorting',
      title: 'Step 4 - Why This Helps You',
      description: 'The last step in the Clarity Formula is explaining why this information is important and how it improves the shared outcome. It signals that you are thinking critically and want to deliver the best work. That changes how it lands.',
      ...
      rounds: [
        {
          ...
          scenarioMessage: {
            sender: 'Your Manager',
            roleLabel: 'Monday morning',
            content: 'Hey - before you start on the homepage copy, just make sure it matches the new direction we talked about.',
            channel: 'slack',
          },
          options: [
        ...
        },
        {
          ...
          scenarioMessage: {
            sender: 'Alex',
            roleLabel: 'Senior colleague',
            content: 'Can you take a look at the deck before it goes to the client and just tighten it up a bit?',
            channel: 'slack',
          },
          options: [
        ...
        },
        {
          ...
          scenarioMessage: {
            sender: 'Project Lead',
            roleLabel: 'Email',
            content: 'We need someone to own the onboarding section of the handbook. Let me know if you can take it on.',
            channel: 'email',
          },
          options: [
        ...
        },
        {
          ...
          scenarioMessage: {
            sender: 'Your Manager',
            roleLabel: 'End of day Friday',
            content: 'Can you pull together a summary of where we are on the project for the leadership update next week?',
            channel: 'slack',
          },
          options: [
      ...
      rounds: [
        {
          ...
          options: [
            { text: 'I felt caught off guard, and it seemed like you did not care whether I was ready for the meeting.', correct: false, explanation: 'This describes a feeling but then guesses at the colleague’s intent instead of staying with the work impact.' },
            ...
            { text: 'The presentation became chaotic at the last minute, and everyone had to scramble because you changed the structure.', correct: false, explanation: 'This uses broad, dramatic language and makes an unsupported claim about everyone’s experience.' },
          ],
        },
        {
          ...
          options: [
            { text: 'The messages make it feel as though you do not respect anyone else’s time or existing priorities.', correct: false, explanation: 'This interprets the colleague’s attitude instead of describing the effect on the work.' },
            ...
            { text: 'The team gets frustrated by these requests because they always seem disorganized and more urgent than necessary.', correct: false, explanation: 'This makes an unsupported claim about the team and labels the requests rather than naming a concrete effect.' },
          ],
        },
        {
          scenario: 'A colleague shares changed deadlines verbally in meetings but does not add them to the written recap.',
          question: 'Which statement most clearly explains the impact?',
          options: [
            { text: 'You never think about how difficult it is for other people to remember everything after a meeting.', correct: false, explanation: 'This makes a broad claim about the colleague’s awareness instead of describing what happened to the work.' },
            { text: 'I missed the changed deadline because it was discussed verbally but was not added to the written recap.', correct: true, explanation: 'This connects the communication behavior to a specific, observable work consequence.' },
            { text: 'Everyone leaves your meetings confused and has to ask around later to figure out what was decided.', correct: false, explanation: 'This overstates the impact and speaks for everyone rather than naming a specific consequence.' },
          ],
        },
      ],
    },
      ...
      rounds: [
        {
          ...
          options: [
            { text: 'I know you wanted to help, but this keeps happening and I need you to stop changing plans on your own.', correct: false, explanation: 'This briefly acknowledges the explanation but shifts into a broad accusation and demand.' },
            { text: 'I understand the goal. The scope change still created rework, so could we discuss additions before changing the plan next time?', correct: true, explanation: 'This acknowledges intent without losing the impact or request.' },
            { text: 'If making the package stronger mattered that much, you should have handled the extra work yourself before changing our deadline.', correct: false, explanation: 'This argues about who should carry the work instead of agreeing on a future process.' },
          ],
        },
        {
          ...
          options: [
            { text: 'I understand you wanted to fix it quickly. When it is not urgent, could you message me first so we can check the context?', correct: true, explanation: 'This acknowledges the possible goal and makes a specific request.' },
            { text: 'Wanting to fix it quickly does not justify correcting me publicly when you have not even checked whether you are right.', correct: false, explanation: 'This escalates the disagreement and assumes the colleague did not check their information.' },
            { text: 'That explanation makes sense, so we can leave the process as it is and hope the context is clearer next time.', correct: false, explanation: 'This acknowledges the explanation but abandons the request for a more workable process.' },
          ],
        },
        {
          scenario: 'A colleague misses a review deadline. When you raise the delay, they say, “My calendar was overloaded and I lost track of it.”',
          options: [
            { text: 'Everyone has a busy calendar, and I need you to be more responsible about checking deadlines before they become a problem.', correct: false, explanation: 'This dismisses the context and asks for a personality change rather than a specific process.' },
            { text: 'I understand your calendar was overloaded. Could you flag conflicts when I send the review request so we can adjust the deadline together?', correct: true, explanation: 'This acknowledges the context and proposes a concrete way to prevent the problem next time.' },
            { text: 'That makes sense; I will send more reminders next time so you do not have to track the review deadline yourself.', correct: false, explanation: 'This removes the colleague’s responsibility instead of creating a shared, workable next step.' },
          ],
        },
      ],
    },
      ...
      rounds: [
        {
          ...
          options: [
            { text: 'In the last two project meetings, you interrupted me several times, and it was frustrating. I need you to be more respectful and listen carefully when other people are speaking.', correct: false, explanation: 'It names a pattern but turns the request into a broad judgment about respect and listening.' },
            { text: 'In the last two meetings, the discussion moved on before I finished answering, so I could not share key context. Could you let me finish before we change topics next time?', correct: true, explanation: 'It names the behavior, explains the impact, makes a specific request, and identifies a next step.' },
            { text: 'I know meetings move quickly, but I did not get to finish my answers. Maybe we could both try to communicate more carefully and avoid misunderstandings in the next meeting.', correct: false, explanation: 'It identifies an effect but makes the requested behavior vague and unnecessarily shared.' },
          ],
        },
        {
          scenario: 'A peer changes the project plan after the team agrees on scope.',
          options: [
            { text: 'Two deliverables were added after we agreed on scope, which changed my estimates. Could we discuss additions before updating the plan so we can adjust the timeline together?', correct: true, explanation: 'It is specific, proportionate, and gives the team a process to try.' },
            { text: 'You changed the plan again after we agreed on scope, which made the project harder for everyone. You cannot keep adding work whenever you feel like it.', correct: false, explanation: 'This names the change but assumes intent, speaks for everyone, and offers no workable process.' },
            { text: 'I saw the new deliverables and adjusted my estimates, but the change was surprising. Please give me more notice next time so this does not become a problem.', correct: false, explanation: 'It identifies some impact, but “more notice” does not establish how scope changes should be discussed or agreed.' },
          ],
        },
        {
          scenario: 'A colleague repeatedly corrects you in a public channel before checking the context.',
          options: [
            { text: 'When corrections are posted publicly before we check the context, the discussion becomes harder to resolve. Could you message me first when the issue is not urgent?', correct: true, explanation: 'It names the pattern, impact, specific request, and a workable next step.' },
            { text: 'When you correct me in the group channel without talking to me first, it feels like you are undermining me and trying to prove that I am wrong.', correct: false, explanation: 'This identifies the setting but guesses at intent and does not propose a future process.' },
            { text: 'The public corrections have made the discussion more confusing for everyone. Please stop correcting anything in the group channel so we can avoid this happening again.', correct: false, explanation: 'This names an impact but makes an overly broad request that does not account for urgent issues.' },
          ],
        },
      ],
    },
