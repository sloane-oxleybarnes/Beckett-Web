...
export const BETA_MISSION_DEFINITIONS: Record<BetaMissionKey, BetaMissionDefinition> = {
  ...
  analyze_with_extension: {
    ...
    category: "Set up",
    title: "Try Beckett on a supported webpage",
    description: "Use the Chrome extension for user-invoked coaching on a supported non-email page. Remove private details if needed.",
  ...
  connect_gmail: {
    key: "connect_gmail",
    category: "Gmail™",
    title: "Install the Gmail™ add-on",
    description: "Install the native add-on so Beckett can coach only on conversations you explicitly analyze.",
    actionLabel: "Open Your Apps",
    href: "/dashboard/apps",
  },
  connect_slack: {
    key: "connect_slack",
