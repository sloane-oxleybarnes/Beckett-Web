...
import { CourseFeedbackTextarea } from '@/features/courses/CourseFeedbackTextarea'
import { useCourseNavigation } from '@/features/courses/use-course-navigation'
import {
...
export default function CourseClient({ initialCourse }: { initialCourse: Course }) {
  ...
  const courseCandidate = initialCourse
  ...
  // ── Phase + navigation ───────────────────────────────────────────────────
  const { phase, setPhase, currentSlideIndex, setCurrentSlideIndex, progressFor } = useCourseNavigation(courseCandidate.slides.length)
